 ...
 */
const getRed = async(reddit) => {
    let sub = await axios.get(`https://meme-api.herokuapp.com/gimme/${reddit}`)
    return sub
}
...
const createSt = async(client, message) => {
    ...
    try {
        ...
        console.log(e)
        client.reply(from, 'Ocurio un error', id)
    }
}



module.exports = { getBuffer, welcome, createSt, getRed }